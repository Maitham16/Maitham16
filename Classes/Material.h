...
// schlick approximation for reflectance of dialectric material (glass) at different angles of incidence and refraction indices (air = 1.0) 
...
public:
    ...
    dialectric(float reference_index) : reference_index(reference_index) {}
