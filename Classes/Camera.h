...
public:
    ...
    // constructor
    Camera(Vec3 look_from, Vec3 look_at, Vec3 up, float fov, float aspect, float aperture, float focus)
    {
    ...
    Ray get_ray(float s, float t)
    {
        ...
        return Ray(position + offset, left + s * horizontal + t * vertical - position - offset);
    }
};
